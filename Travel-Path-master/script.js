onload = function () {
            ...
            if (n1 !== n2) {
                ...
                if (works <= 1) {
                    if (works === 0 && i < V / 4) {
                        ...
                        // Adding a plane
                        edges.push({ type: 1, from: n1, to: n2, color: 'green', label: String(Math.floor(Math.random() * 100) + 1) });
                    }
                    i++;
                }
            }
    ...
    genNew.onclick = function () {
        ...
        // Trigger world map animation
        genNew.classList.add('animate');
        setTimeout(() => {
            genNew.classList.remove('animate');
        }, 1000);
    };
    ...
    solve.onclick = function () {
        ...
        solve.classList.add('animate');
        setTimeout(() => {
            solve.classList.remove('animate');
        }, 1000);
    };
